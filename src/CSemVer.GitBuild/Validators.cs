...
/*
Other than this comment block this entire file is a duplicate from the Argument.Validators project.
It is duplicated here to break cyclical dependencies between the packages. Despite the fact that
the build tasks are development dependences. Nuget's support of Development dependencies with the
transitive restore of PackageReferences is a big mess at this point. Just copying this file saves
a bunch of hassle to deal with Nuget doing things it shouldn't be doing.
*/
