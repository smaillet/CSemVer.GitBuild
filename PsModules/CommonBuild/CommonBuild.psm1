...
#>
    ...
    {
        $xmlPath = Join-Path $buildInfo['RepoRootPath'] 'BuildVersion.xml'
    }
...
#>
    ...
    $buildInfo['CiBuildName'] = $env:CiBuildName
    $buildInfo['BuildTime'] = $env:BuildTime
    return $buildInfo
}
...
.PARAMETER minVersion
    Minimum version of CMAKE allowed. Older versions trigger an exception
#>
